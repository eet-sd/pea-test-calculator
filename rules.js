...
// ---------------------------------------------------------------------------
// ข้อมูลแสดงผลรายรหัสพัสดุที่ผูกกับ "จำนวน" — ไม่กระทบการคำนวณใดๆ จึงไม่ต้อง port
// ไปไฟล์ mirror test_rules.py ของ cost_estimate ซึ่ง mirror เฉพาะกติกาจำนวนตัวอย่าง
//   unit / en   หน่วยของช่อง "จำนวนที่ซื้อ / ส่งมอบต่องวด" (ไม่ระบุ = "ตัว")
//   sampleNote  ข้อกำหนดขนาดตัวอย่างที่ต้องส่งทดสอบ แสดงเป็นหมายเหตุใต้ตาราง
window.QTY_INFO = {
  // ลวดเหล็ก (RCBL-007/2569) — เส้นเดี่ยวขายเป็นขด ส่วนตีเกลียวขายเป็นเมตร
  "1010100000": { unit: "ขด",   en: "Coil(s)",  // WIRE,ST. SOLID DIA. 4.0 MM.
                  sampleNote: "ความยาวไม่น้อยกว่า 3 เมตร/ตัวอย่าง" },
  "1010100002": { unit: "เมตร", en: "m",        // ST. WIRE, STRANDED 25 SQ.MM.
                  sampleNote: "ความยาวไม่น้อยกว่า 5 เมตร/ตัวอย่าง" },
  "1010100003": { unit: "เมตร", en: "m",        // ST. WIRE, STRANDED 35 SQ.MM.
                  sampleNote: "ความยาวไม่น้อยกว่า 5 เมตร/ตัวอย่าง" },
  "1010100004": { unit: "เมตร", en: "m",        // ST. WIRE, STRANDED 50/7 SQ.MM.
                  sampleNote: "ความยาวไม่น้อยกว่า 5 เมตร/ตัวอย่าง" },
  "1010100006": { unit: "เมตร", en: "m",        // ST. WIRE, STRANDED 95 SQ.MM.
                  sampleNote: "ความยาวไม่น้อยกว่า 5 เมตร/ตัวอย่าง" }
};
